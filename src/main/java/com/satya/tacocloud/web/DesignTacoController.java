...
import com.satya.tacocloud.domain.Ingredient;
import com.satya.tacocloud.domain.Ingredient.Type;
import com.satya.tacocloud.domain.Taco;
...
public class DesignTacoController {
    ...
    public String showDesignForm(Model model){
        ...
        log.info("In showDesignForm {}", model);
        return "design";
    }
